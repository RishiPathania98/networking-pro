  ...
  return (
    <div className="user_details_container">
      ...
      <div className="user_details_div">
        <p className="user_details_div_title">Rishi Pathania</p>
        <p>rishipathania98@gmail.com</p>
      </div>
      <hr />
      <div>
        <div className="user_details_stats">
          <p>Who viewed you?</p>
          <p className="user_details_stats_highlight">204</p>
        </div>
        <div className="user_details_stats">
          <p>Views on post</p>
          <p className="user_details_stats_highlight">300</p>
        </div>
      </div>
    </div>
  );
